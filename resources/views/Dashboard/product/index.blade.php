                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th> <img width="75" height="75" src="{{ url('../storage/app/images/products/'.$value->image) }}" alt="{{ $value->name }}"> </th>
                                            <th> {{ $value->category->name }} </th>
                                            <th>
                                                <a class="btn btn-primary" href="{{ url('product/' . $value->id . '/edit') }}">Edit</a>
